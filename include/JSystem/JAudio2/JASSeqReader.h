...
public:
    ...
    u32 read16() {
        auto value = *(reinterpret_cast<u16*>(this->field_0x04));
        this->field_0x04 += sizeof(u16);
        return value;
    }
    u32 read24() {
        auto value = *(reinterpret_cast<u32*>(this->field_0x04));
        this->field_0x04 += sizeof(u32) - sizeof(u8);
