...
// l_pos is unused
//static f32* l_pos_get()      { alignas(32) static f32 buf[507];   static bool _ = (dusk::LoadRelAsset(buf, "/rel/Final/Release/d_a_mant.rel", {{GameVersion::GcnUsa, 0xA44C}, {GameVersion::GcnPal, 0xA44C}, {GameVersion::GcnJpn, 0xA44C}}, sizeof(buf)),   true); return buf; }
