...
std::vector<AchievementSystem::Entry> AchievementSystem::makeEntries() {
    return {
        ...
        {
            {
                "sword_and_shield_skip",
                "Sword and Shield Skip",
                "Pass through the Twilight Wall in Ordon Spring before obtaining both the Ordon Sword and Shield.",
                AchievementCategory::Glitched,
                false, 0, 0, false
            },
            [](Achievement& a, json&) {
                ...
                if ((!hasOrdonSword || !hasOrdonShield) && dComIfGs_isEventBit(dSv_event_flag_c::M_013)){
                    a.progress = 1;
                }
